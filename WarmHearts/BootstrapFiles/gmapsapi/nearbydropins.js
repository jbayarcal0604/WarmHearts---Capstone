function initMap() {
  ...
  navigator.permissions.query({name: 'geolocation'}).then(function(permissionStatus) {
    if (permissionStatus.state === 'granted') {
      // User granted permission to access their location.
      // You can now use the getCurrentPosition() method to access their location.
    } else if (permissionStatus.state === 'prompt') {
      // User has not previously granted or denied permission.
      // You can now prompt the user for permission using the getCurrentPosition() method.
    } else if (permissionStatus.state === 'denied') {
      // User has previously denied permission.
      // You can now display an error message or disable certain features that depend on location access.
    }
  });
